<%@ Page Title="" Language="VB" MasterPageFile="~/menu.master" AutoEventWireup="false" CodeFile="graficos.aspx.vb" Inherits="graficos" %>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Acompanhamento de Resultados
                        </div>
                        <!-- /.panel-heading -->
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Acompanhamento de Resultados 2
                ...
                <div class="col-lg-4">
                        ...
                        <div class="panel-body">
                            <div class="list-group">
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-bolt fa-fw"></i> Nova ocorrência
                                    <span class="pull-right text-muted small"><em>4 minutos</em>
                                    </span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-user-secret fa-fw"></i> Nova ocorrência
                                    <span class="pull-right text-muted small"><em>12 minutos</em>
                                    </span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-lightbulb-o fa-fw"></i> Nova ocorrência
                                    <span class="pull-right text-muted small"><em>27 minutos</em>
                                    </span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-bomb fa-fw"></i> Nova ocorrência
                                    <span class="pull-right text-muted small"><em>43 minutos</em>
                                    </span>
                                </a>
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-bolt fa-fw"></i> Nova ocorrênciad
                                ...
                                <a href="#" class="list-group-item">
                                    <i class="fa fa-warning fa-fw"></i> Nova ocorrência
                            ...
                            <!-- /.list-group -->
                            <a href="#" class="btn btn-default btn-block">Ver todas as notificações</a>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Acompanhamento de Resultados 3
                        </div>
                        <div class="panel-body">
